    ...
    return (
        <Container className='card' style={{ textAlign: "center", width: '80em', background: 'rgb(242, 239, 229, 0.2)', paddingBottom: "1em", paddingTop: "1em" }}>
            <Row >
                ...
                <Col md={7}><h4>Nice job! Here's just one more exercise for you to do..</h4></Col>
                        ...
                        <Card >
                            <Card.Body>
                                <Card.Text>
                                    ...
                                    Now that you've got the hang of it, let's try another example of a decision tree.
                                    This one would be helpful if you literally have no clue as to what to do with yourself. <br /><b>Let's try it out.</b>
                            ...
                            <Card >
                                <Card.Body>
                                    <Card.Text>
                                        ...
                                        Today is a pretty gloomy day and you have been calling your friends but they are all busy with the assignment you have also not yet finished and the deadline is in 3 hours. <br /><b>What do you do?</b>
                            ...
                            <Card >
                                <Card.Body>
                                    <Card.Text>
                                        ...
                                        It's a beautiful summer day, you are at the seaside with your family and your parents are not bugging you to do chores.<br /><b>What do you do?</b>
                            ...
                            <Card >
                                <Card.Body>
                                    <Card.Text>
                                        ...
                                        Since it's been raining cats and dogs the last couple of weeks you have catched up on all your work, both at work and at home. Next thing you know Barbara just texted you if you want to hang out. <br /><b>What do you do?</b>
